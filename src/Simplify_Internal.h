...
public:
    ...
    void populate_excluded_ruleset() {
        ...
        excluded_rules.insert("add100");
        excluded_rules.insert("add101");
        excluded_rules.insert("add102");
        excluded_rules.insert("add103");
        excluded_rules.insert("add104");
        excluded_rules.insert("add105");
        excluded_rules.insert("add106");
        excluded_rules.insert("add107");
        excluded_rules.insert("add108");
        excluded_rules.insert("add109");
        excluded_rules.insert("add110");
        excluded_rules.insert("add111");
        excluded_rules.insert("add112");
        excluded_rules.insert("add113");
        excluded_rules.insert("add114");
        excluded_rules.insert("add115");
        excluded_rules.insert("add116");
        excluded_rules.insert("add117");
        excluded_rules.insert("add118");
        excluded_rules.insert("add119");
        excluded_rules.insert("add120");
        excluded_rules.insert("add121");
        excluded_rules.insert("add122");
        excluded_rules.insert("add123");
        excluded_rules.insert("add124");
        excluded_rules.insert("add125");
        excluded_rules.insert("add126");
        excluded_rules.insert("add127");
        excluded_rules.insert("add128");
        excluded_rules.insert("add139");
        excluded_rules.insert("div178");
        excluded_rules.insert("div179");
        excluded_rules.insert("div180");
        excluded_rules.insert("div181");
        excluded_rules.insert("div182");
        excluded_rules.insert("div183");
        excluded_rules.insert("div184");
        excluded_rules.insert("div185");
        excluded_rules.insert("div186");
        excluded_rules.insert("div187");
        excluded_rules.insert("div188");
        excluded_rules.insert("div189");
        excluded_rules.insert("div190");
        excluded_rules.insert("div191");
        excluded_rules.insert("div192");
        excluded_rules.insert("div193");
        excluded_rules.insert("div194");
        excluded_rules.insert("div195");
        excluded_rules.insert("sub68");
        excluded_rules.insert("sub69");
        excluded_rules.insert("sub70");
        excluded_rules.insert("sub71");
        excluded_rules.insert("sub72");
        excluded_rules.insert("sub73");
        excluded_rules.insert("sub74");
        excluded_rules.insert("sub75");
        excluded_rules.insert("sub76");
        excluded_rules.insert("sub77");
        excluded_rules.insert("sub78");
        excluded_rules.insert("sub79");
        excluded_rules.insert("sub80");
        excluded_rules.insert("sub81");
        excluded_rules.insert("sub82");
        excluded_rules.insert("sub83");
        excluded_rules.insert("sub84");
        excluded_rules.insert("sub85");
        excluded_rules.insert("sub86");
        excluded_rules.insert("sub87");
        excluded_rules.insert("sub88");
        excluded_rules.insert("sub89");
        excluded_rules.insert("sub90");
        excluded_rules.insert("sub91");
        excluded_rules.insert("sub92");
        excluded_rules.insert("sub93");
        excluded_rules.insert("sub94");
        excluded_rules.insert("sub95");
        excluded_rules.insert("sub96");
        excluded_rules.insert("sub97");
        excluded_rules.insert("sub98");
        excluded_rules.insert("sub99");
        excluded_rules.insert("max52");
        excluded_rules.insert("max53");
        excluded_rules.insert("max54");
        excluded_rules.insert("max55");
        excluded_rules.insert("max56");
        excluded_rules.insert("max57");
        excluded_rules.insert("max58");
        excluded_rules.insert("max59");
        excluded_rules.insert("max60");
        excluded_rules.insert("max61");
        excluded_rules.insert("max62");
        excluded_rules.insert("max63");
        excluded_rules.insert("max64");
        excluded_rules.insert("max65");
        excluded_rules.insert("max66");
        excluded_rules.insert("max67");
        excluded_rules.insert("max68");
        excluded_rules.insert("max69");
        excluded_rules.insert("max70");
