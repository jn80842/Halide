            ...
            (rewrite(broadcast(x) / broadcast(y), broadcast(x / y, lanes)) ||
             ...
             (no_overflow(op->type) &&
              (// Fold repeated division
               ...
               (!exclude_misordered_rules && rewrite((x * c0 - y) / c1, (-y) / c1 + x * fold(c0 / c1),          c0 % c1 == 0 && c1 > 0)) ||
               ...
               rewrite(((x * c0 + y) - z) / c1, (y - z) / c1 + x * fold(c0 / c1), c0 % c1 == 0 && c1 > 0) ||
               (!exclude_misordered_rules && rewrite(((x * c0 - y) - z) / c1, (-y - z) / c1 + x * fold(c0 / c1), c0 % c1 == 0 && c1 > 0)) ||
