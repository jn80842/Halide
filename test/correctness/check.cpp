...
Expr ramp(const Expr &base, const Expr &stride) {
    return Ramp::make(base, stride, 2);
}

Expr broadcast(const Expr &base) {
    return Broadcast::make(base, 2);
}
...
int main(int argc, char **argv) {
    Expr x = Var("x"), y = Var("y"), z = Var("z"), w = Var("w"), u = Var("u"), v = Var("v");
    Expr c0 = Var("c0"), c1 = Var("c1"), c2 = Var("c2"), c3 = Var("c3");
